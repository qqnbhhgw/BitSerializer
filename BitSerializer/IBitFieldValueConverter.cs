...
public interface IBitFieldValueConverter
{
    ...
    /// 重写此方法以在转换时访问上下文对象。
    /// </summary>
    static virtual object OnDeserializeConvert(object formDataValue, object? context)
    ...
    /// 重写此方法以在转换时访问上下文对象。
    /// </summary>
    static virtual object OnSerializeConvert(object propertyValue, object? context)
        => throw new NotSupportedException();
}
